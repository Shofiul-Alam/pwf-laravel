...
class EmployeeAllocationController extends ApiController
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('transform.input:'. EmployeeAllocationTransformer::class)->only(['store', 'update']);
    }
    ...
    {
        $employeeAllocations = EmployeeAllocation::all();

        return $this->showAll($employeeAllocations);
    }
